...
class Drips extends React.PureComponent {
  ...
  render() {
    ...
    switch (this.props.chapter) {
      ...
      <D c={c} t={463006} f={129133} q={6000}><U>[dddfffdfdd]</U> > If youre against Violent Aron but still support Jimmi Smxooxth, who litrally chucked his dog onto the roof of his living facility (video in bio), then you are apart of the problem.</D>
      ...
      case "officeChitChat":
      return (<div><D c={c} t={1274078} f={434259} q={3113}><U>[NewsNEWSjc$d*]</U> > TWO DEAD cuz of crashing Dimples <U>[Dimples:)]</U> zoftware? DOINK! Sip for more updates.</D></div>);

...
<Z d={20} spe={55} u="j29" o={0} f={setZoip} s={state.zoips} first> dinner would be great, actually</Z>
<Z d={30} spe={65} u="j29" o={1} f={setZoip} s={state.zoips}>I'll let you know when I get off work</Z>
...
<Z d={70} spe={70} u="n31" o={2} f={setZoip} s={state.zoips} first> Very good,</Z>
<Z d={35} spe={80} u="n31" o={3} f={setZoip} s={state.zoips}>that way I can put the tangy toast in the oven.</Z>

...
<Z d={20} spe={55} u="j29" ch={num} o={0} z={state} first> dinner would be great, actually</Z>
<Z d={30} spe={65} u="j29" ch={num} o={1} z={state}>I'll let you know when I get off work</Z>
...
<Z d={70} spe={70} u="n31" ch={num} o={2} z={state} first> Very good,</Z>
<Z d={35} spe={80} u="n31" ch={num} o={3} z={state}>that way I can put the tangy toast in the oven.</Z>

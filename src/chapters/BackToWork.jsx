...
<Z d={30} spe={70} u="q31" ch={num} seq="b" o={0} z={state} p={[`ch${num}_a`, 2]} f> Very good,</Z>
<Z d={25} spe={80} u="q31" ch={num} seq="b" o={1} z={state} l>that way I can put the tangy toast in the oven.</Z>
<Pp bg="#C5DCA0, #A491D3">

...
const MeetingMjmubhe = ({ children, num, state }) => (
<div>
...
<Pp>Quimby31 drops down. “So this is terrace Star-Circle-Octagon.” They blow warm air on their raw hands. “There should be an Ascent Station about a twentyleap and a half north from here.”</Pp>
...
<Pp>A twentyleap isn’t that far, and a couple is literally only a bit farther. My thoughts are feeling quiet like a church. The mound is icy-slick as it slopes downward. I slip once and nearly plop on my bottom. Quimby31 leans forward like they're there to catch me but not enough that they’d be able to break my fall; it’s more of a symbolic gesture.</Pp>
...
<Pp>Quimby31 is still shivering quite a lot. I’m a little nervous about their comfort. “What do you like to do for fun, Mjmubhe__?”</Pp>
...
<Pp>Quimby31: “What do you do for work?”</Pp>
<Pp>“I play <span class="t">*</span>day in and <span class="t">*</span>day out on the seesaw.”</Pp>
<Pp>“Jim29 and I both love the seesaw too.”</Pp>
<Pp>“Oh, how I hate the seesaw. I have nary a soul to seesaw with. All alone. Not even anyone to talk to, besides momma of course. Alas if we are lacking seesaw power, we cannot pump water, zilch, might as well be pumping dust, understand? The special seesaw is a water pumping kind, and a gift from the entrepreneur charity. How stupendous.” She stumbles over a threatening crag. “Grandpoppie needs brand spanking new water all over his body, at all times, every <span class="t">*</span>day.”</Pp>
...
<Z d={10} spe={65} u="j56" ch={num} o={0} z={state} f> what’s all this about this bug of yours killing people?</Z>
<Z d={8} spe={68} u="j56" ch={num} o={1} z={state} l>i know it’s not fully your fault or whatever but good jesus.</Z>
...
<Pp>Quimby31 puts their arm on my shoulder. “It’s OK if you can’t fix it.”</Pp>
...
<Pp>I forget to even type anything in before hitting return. It makes a beautiful boingy boing noise and a loading screen pops up, informing me that it is Scavenging For System Dump, Please Sit Still A Few <span class="t">*</span>seconds. The account’s password must’ve just been blank. I didn’t even know blank passwords were allowed. The loading animation depicts a very small man pushing an even smaller rock up a little pipsqueak hill. He just can’t quite seem to push it all the way to the top without losing his grip. The stone rolls very quickly all the way back down over and over and over in fluid vector animation. I wish it would just show a percentage instead. <span class="t">*</span>minutes pass by.</Pp>
<Pp>Mjmubhe__ is walking around in a circle, stepping one foot in front of the other, arms outstretched for balance. She must have placed her torch in a wall mounted sconce. Quimby31 is on her celly and scrolling, eyes darting up, down, zigzagging around.</Pp>
...
<Pp>“Did you hear that more than hundred thousand are confirmed dead because of that quake?” Quimby31 is hugging their celly against their chest. “That’s unbelievable.”</Pp>

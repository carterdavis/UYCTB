...
<Pp bg="#f0d88e, #e1a4bd">
<p>Dimples offered me 120 ingots of gold for a starting salary. I argued them up to 150 ingots on account of the cost of living in a metropolitan area. I probably could’ve asked for 5 or 10 ingots on top of that but I was nervous I’d seem like a greedy goblin prince. Their benefits package included body insurance covering punctures and smacks, <Snip screenWidth={state.screenWidth} bg='#3a3a3a'>A smack is defined as a “doink” or a “bonk.”</Snip> armed and unarmed robbery insurance, kidnapping insurance, poisoning insurance, <Snip screenWidth={state.screenWidth} bg='#e1a4bd'>There is a distinction between “poison” and “venom.”</Snip> and complimentary access to an underground swimming pool, which would be nice if I knew how to swim.</p>

...
<Pp>It's very difficult to quantify how much progress a dev will make on any given *day. A misplaced semicolon or an incorrectly capitalized variable can demand *hours of debugging. Zoftware development is like solving a series of interlocking riddles. Some *days everything works perfectly, some *days everything goes wrong.</Pp>
<Pp>Programming brings human flaws into uncomfortably sharp focus. Computering devices don't make mistakes. They follow instructions perfectly, but are subject to the whims of the instructor. The code that powers our daily activities and binds our world together is the product of innumerable *weeks of cooperative, inventive human toil. Some bridges have cracks because the person pouring cement didn't get enough sleep. Bugs are not mysterious. They're lucid evidence that the people that *day weren't thinking hard enough.</Pp>
{props.children}</div>
);

...
<Pp>Programming brings human flaws into uncomfortably sharp focus. Computering devices don’t make mistakes. They follow instructions perfectly, but are subject to the whims of the instructor. The code that powers our daily activities and binds our world together is the product of innumerable <span class="t">*</span>weeks of cooperative, inventive human toil. Some bridges have cracks because the person pouring cement didn’t get enough sleep. Bugs are not mysterious. They’re concrete evidence that the people that <span class="t">*</span>day weren’t thinking hard enough.</Pp>
{children}</div>
);

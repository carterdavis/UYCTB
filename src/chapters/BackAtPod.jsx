...
<Pp>The slide drops me off on the fifth floor. My brain feels tremendous, like a comet across the cloudy sky. That splash did me a world of good. Everything will be OK, it seems like. I’m safe, and that’s all that matters, yes? Right on!!</Pp>
...
<Pp>Outside, my workpod is situated between a wall and a load bearing column, directly below a toasty heat vent. A circular window in my pod lets some light in but it’s slightly too high up for me to comfortably peer. Mostly it creates a bunch of glare for my computerior’s screen. The tinted glass shell of the building renders everything outside too dark and too red to make out. My inner desk is a mess and I’m pretty ashamed of it if I’m being totally honest. It’s piled up with treat wrappers, snotty balled-up tissues, empty Queam canisters, plastic bags, crumbs, soiled bandages, hunks of gold, branded pens, colorful squishy toys, print-outs of a few online articles, and a glass terrarium one of my friends sent me with a plastic succulent inside that I named Genius. I’m not a messy person, I just have a very hard and stressful job, and almost all experts agree that it’s normal to accumulate a bit of clutter. My personal computering device is very sleek and flimsy, and its keys are illuminated with multisegmented efficiency glyphs. When I sit at my desk I leave it hooked up to my monitor, which has a state-of-the-art razor-thin curved Ultradef screen that wraps halfway around my head. My typing stool squawks as I roll it into sitting position. One of the custodians must have forgotten to grease its axles. That’s the third time this <span class="t">*</span>week. I’ll have to submit a report. Either way, the cushion feels great when I plop my big booty on it.</Pp>
<Pp>I hook in my umbilical data plug and load up TunesJam, my music subscriptional of choice. My Recommended Jam of the <span class="t">*</span>Day is “Requiem Of The Aether Maidens" by Bladetooth. I eagerly press play. They’re my favorite legendary metal group. They mostly sing about the kind of stuff our great ancestors were up to a gazillion <span class="t">*</span>years ago. The guitars chug and wail as I imagine legions of goblins approaching on horseback.</Pp>
...
<Pp>But today seems to be a good <span class="t">*</span>day for Doby22. I don’t have much to report. He is seated in his shiny chair, speaking into his great big microphone, smiling wide. Not very interesting. Staring time is over.</Pp>
...
<Pp c="chapterImage">
  <LazyLoad offset={100} height={661} once>
    <img src="assets/chapter6.jpg" />
  </LazyLoad>
</Pp>
<Pp>She occasionally glances up, briefly making eye contact, still typing. “Would you mind if I tried to make you laugh?”</Pp>
<Pp>“Go for it.”</Pp>
<Pp>“I was imagining earlier today how it would be if I were an astronaut, and like, I landed on a great big asteroid just fine, and I’m in my asteroid space home on my very first night sleeping there, and, like, so then I realize while I’m like getting ready for bed that I left all my own dam pajamas back on this planet.”</Pp>
...
<Pp>“Ha ha ha. By the way! Do you think the meeting in forty <span class="t">*</span>minutes is officially mandatory?” Sometimes she says the last few words of a sentence a little slowly for added emphasis.</Pp>
<Pp>I pick up my computerior. “Last I heard it was postponed until tomorrow.”</Pp>
<Pp>“Oh is that so?” She stretches the sleeves of her foam sweater past her knuckles. She hums thoughtfully.</Pp>
...
<Pp>She winces. I’m not sure if it’s because of what I said or maybe she read something on her celly that was bad. She’s still tapping away. Must be typing a really long message. She glances back up. “Ah, what in tarnation. Does it seem like it’ll be tricky to fix?”</Pp>
<Pp>“I’m not sure. I don’t want to talk about it anymore actually. Sorry. Have you been having a good <span class="t">*</span>day?” I exhale slowly.</Pp>
<Pp>“I would say that mine has been really good, thanks for asking.”</Pp>
<Pp>“Yah, no sweat. You know what I’ve been thinking about? How come we never got wings.”</Pp>
<Pp>“What do ya mean?”</Pp>
<Pp>“I’m just saying the world would be much safer if we had wings. We could traverse treacherous terrain as if it weren’t a big thang.”</Pp>
...
<Pp>“You think maybe God wanted to keep us on the ground?”</Pp>
<Pp>“Hm.”</Pp>
<Pp>“Down in the muck and the mire or whatever?”</Pp>
<Pp>“Yah. Seems like it.”</Pp>
<Pp>“By the way, I was thinking I’d swing by the GrubZone. Do you want me to grab you a bowl of flakes, or even something else? Doesn’t have to be flakes.”</Pp>
<Pp>“I think I’m fine without, but it’s so nice of you to offer!”</Pp>

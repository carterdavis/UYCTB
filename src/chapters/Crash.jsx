...
<div>
<ChapterStart num={num} bg="#4666d9, #DE4290" />
{children}
...
<picture>
  ...
  <p>I appreciate Nug20’s laconic persona. Most of us talk as much as possible to feel less alone but he seems to have alone pretty under control. (As a side note, I think I’m just going to relay NiceTime Perfect Units in this log as truncated <span className="t">*</span>seconds, <span className="t">*</span>minutes, <span className="t">*</span>days, etc. I’ll explain why in this little spheroid if you want to give it a click, up to you: <Snip screenWidth={state.screenWidth} bg='#DE4290'>Oh goody, you clicked it! I think I’ll use these to fill you in on stuff you might not know and embark on fanciful detours. Anyways, I know this violates NiceTime’s branding or whatever. But out of everyone, shouldn’t they particularly understand that our time together is limited? Is that OK with you? I hope that doesn’t make you uncomfortable. I can also convert it to a different chronobrand if you’d like. This whole sector uses NiceTime which, if you ask me, has really taken a toll on Big Town. Business Time feels so long and Pleasure Time feels so short. No time for relaxing. Sometimes I can tell when they’re dilating the <span className="t">*</span>minutes. Like this one, for instance. Very lengthy.</Snip>)</p>
  <p>I blink hard to wake my eyes up and sip my bubbly Strawbberry Queam. Have you ever tried Queam? I suck down a few canisters of this junk every <span className="t">*</span>day. It’s sticky and gummy and viscous, and every sip is a zippity zappity BURST of fruity flavor that rocks my world. Red ropes of corn syrup congeal against my teeth and I chisel em off with my tongue. “How have the users been?” I crack a hesitant grin. “Are they whining? Throwing tantrums?”</p>
  ...
  <p>“When I was a kid and someone told me super bad news like this I’d just sit in my room and scream for <span className="t">*</span>hours.”</p>

...
<Pp>Routines are important for birdies. I feed him every <span class="t">*</span>day when Pleasure Time ends and Business Time starts, so roughly 6:00bt...any later and he starts to shriek, ha ha. I should actually go set a timer real quick. Look at you, buddy! Gosh look at you!! You're growing up so fast.</Pp>
<Z d={1} u="j56">jumper56ok : don't you hate having to wipe your rear?</Z>
<Z d={10} u="j29">funguyjim29 : hmm. i guess so.</Z>
<Z d={15} u="j29">~ : never really thought much about that before</Z>
<Z d={30} u="j56">jumper56ok : thought at this point we would have some sort of</Z>
<Z d={38} u="j56">~ : gadget or whatever</Z>
<Z d={40} u="j56">~ : to do it for us</Z>
...
<Z d={15} u="j29">~ : on the other hand, its a complex task</Z>
<Z d={20} u="j29">~ : a lot could go wrong</Z>
<Z d={30} u="j29">~ : many different strategies to consider</Z>
<Z d={50} u="j56">jumper56ok : true, i would not want it to go wrong!!!</Z>
<Pp>I made a mistake today, Boing. Two people died because of it. On top of that, everyone knows about it. Or at least half of everyone. I can't go to prison. That would suck so bad!! I don't even understand what I did. Empty, inky, endless death. Who knows who'll be the next. Maybe death isn't too bad. Maybe it feels great. I guess you'd probably know better than me. It's just the opposite of whatever you just learned is right now. C'mon, I'm not a bad one, right? I've gotta be one of the good ones. I do so much for you.</Pp>
<Pp>Doesn't his beak make it look like he's smiling?</Pp>
<Pp>I hope your <span class="t">*</span>day was really good, Boing. I want your whole life to be so so so non-stop unrelentingly perfect. Stop biting my fingernail. Yowch! I don't like that. That hurts. That's the kind of thing bad ones do. I love you, sorry, I just don't like that. Man, your eyes are seriously so pretty. They're just like jewels. I have to set you back down, buddy. Sounds like Boom wants his fruit chunk.</Pp>
{children}</div>
);

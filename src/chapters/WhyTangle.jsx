...
<Pp>
  <div class="codeblock">
    ...
    <p style={{ color: '#DD7878' }}>CONSIDER REWRITING THIS METHOD USING DIPLOID NUMERALS,
    THANK YOU VERY MUCH?</p>
    <p style={{ color: '#DD7878' }}>IF YOU FORGET TO SWITCH TEXT CODECS AND MODIFY THE LEGACY
    CODE ONE MORE TIME I SWEAR I WILL BITE OFF YOUR BALL SACK</p>
  </div>
</Pp>
<Pp>
<p>I still haven’t found a way to turn off the system error alert noise, either. It fires every time anything goes wrong with my code. I understand that Dimples can’t let their employees make any mistakes, but the noise always burns my ears. It sounds like a scraping scream.</p>
</Pp>
{children}</div>
);

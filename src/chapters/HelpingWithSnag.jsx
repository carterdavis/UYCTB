...
<Pp>“No, see, the stool is the test directory. The error said it was in the <Code>SCREEN</Code> class. Maybe see if the window has it?” I squint. She must have her brightness turned all the way up.</Pp>
...
<Pp>“Open up <Code>when-spat-screen-upside-down.tangle</Code>, I think that’s what the error was referring to. Are you familiar with the Spat Screen code?”</Pp>
...
<Pp>Code zooms around her monitor in bright primary colors. She sets down her celly and navigates the document with her trackballs. They spin really fast. She stops in front of a line of code lit up black and bold. “It just says <Code>BENDY</Code> is equal to <Code>THIN</Code> times <Code>SOFT</Code>.”</Pp>
<Pp>“<Code>BENDY</Code> must be defined differently elsewhere. Somehow the two values of <Code>BENDY</Code> are ending up different. I guess it says here that the compiler was trying to set 2 equal to 7. So that’s why it ended up with a Disequalized Int to Int error.” Int to Int means Integer to Integer.</Pp>

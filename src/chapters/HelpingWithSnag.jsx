...
<Z d={70} spe={70} u="n31" seq="a" ch={num} o={0} z={state.zoips} first> I'm sorry for not responding last night.</Z>
<Z d={40} spe={80} u="n31" seq="a" ch={num} o={1} z={state.zoips}>What's been rough lately? I'm free tonight, if you want to have dinner.</Z>
